...
<html lang="es">
	<head >
		...
		<script lang="JavaScript" src="../../js/ajax/ajaxSalidaInsumo.js" ></script>
		<script lang="JavaScript" src="../../js/ajax/ajaxcomboInsumo.js" ></script>
		<script lang="JavaScript" src="../../js/ajax/ajaxComboCultivos.js" ></script>
		<script lang="JavaScript" src="../../js/json/jsonSalidaInsumo.js" ></script>
		<script lang="JavaScript" src="../../js/jquery/jquerySalidaInsumo.js" ></script>
		...
		<body>
			...
			<form id="f_registrar">
				...
				<h1>Registrar Salidas de Insumos</h1>
				<br>
				...
				<div class="form-group col-md-6">
                <label>Cultivo:</label>	
				<select id="cultivo" style="width:150;" class="form-control"></select>
				</div>
				<!--<p>
                <label>Cultivo:</label>	
			...
			<DIV id="contenedor"></DIV>
				...
				<br><br></br></br>
				<h1>Lista de Salidas de Insumos </h1>
				<br><br></br></br>
